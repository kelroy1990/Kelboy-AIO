...
{
   if((value < _xAxisMinimum) || (value > _xAxisMaximum)){
      return;
      }
...
{
   if((value < _yAxisMinimum) || (value > _yAxisMaximum)){
      return;
      }
...
{
   if((value < _zAxisMinimum) || (value > _zAxisMaximum)){
      return;
      }
...
{
   if((value < _rxAxisMinimum) || (value > _rxAxisMaximum)){
      return;
      }
...
{
   if((value < _ryAxisMinimum) || (value > _ryAxisMaximum)){
      return;
      }
...
{
   if((value < _rzAxisMinimum) || (value > _rzAxisMaximum)){
      return;
      }
...
{
   if((value < _rudderMinimum) || (value > _rudderMaximum)){
      return;
      }
...
{
   if((value < _throttleMinimum) || (value > _throttleMaximum)){
      return;
      }
...
{
   if((value < _acceleratorMinimum) || (value > _acceleratorMaximum)){
      return;
      }
...
{
   if((value < _brakeMinimum) || (value > _brakeMaximum)){
      return;
      }
...
{
   if((value < _steeringMinimum) || (value > _steeringMaximum)){
      return;
      }
